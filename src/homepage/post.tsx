...
//   useEffect(()=>updateReaction(box.box.self_reaction_data.reaction_type),[])
    ...
    return <div id='postbox'>
        ...
        <div id="comment"><input className="commentInput" style={{}} onKeyDown={(e)=>{if(e.code==='Enter'){postComment(e)}}} placeholder="Comment Box"/><img className="commentAvatar" src={avatar} /></div>
