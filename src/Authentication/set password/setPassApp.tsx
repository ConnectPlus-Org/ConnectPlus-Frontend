...
function Passwordset() {
  ...
  function handlepass(e: any) {
    ...
    if (
      ...
      else document.getElementById("passb")!.style.borderColor = "#66DF98";
    } else {
  ...
  function handlepass2(e: any) {
    ...
    if (password === e.target.value || e.target.value === "") {
      ...
      else document.getElementById("pass2b")!.style.borderColor = "#66DF98";
    } else {
    ...
    <div>
      {loading ? (
        ...
        <div>
          ...
          <div id='setpass'>
            <div>
              <h1 className='topline'>Set password?</h1>
              <p className='middle'>No worries, set password</p>
            </div>
            <form
              style={{
                height: "25vw",
