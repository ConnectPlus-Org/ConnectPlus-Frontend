...
const Comment = (comm: any) => {
  ...
  var replyBox = document.getElementsByClassName(
    replyClass
  ...
  return (
    <div style={{ margin: "2vw 0" }} id='comment'>
      <p>
        <img src={comm.comm.comment_owner_profile.avatar} />
        {comm.comm.comment_owner_profile.name}
